...
t_onReady(function () {
	...
	t && ((e = t.getAttribute("data-tilda-project-lang")) && (window.t_forms__lang = e), (r = t.getAttribute("data-tilda-root-zone")) && (window.tildaForm.endpoint = "forms.tildaapi." + r)),
	t_forms__initForms();
...
window.tildaForm_customMasksLoad = function () {
	var t;
	!0 !== window.isInitEventsCustomMask && ((t = document.createElement("script")).type = "text/javascript", t.src = "https://static.tildacdn.com/js/tilda-forms-custommask-1.0.min.js", document.head.appendChild(t), t.onload = function () {
		window.isInitEventsCustomMask = !0
	})
},
window.tildaForm_initMasks = function () {
	var t = document.querySelectorAll(".js-tilda-mask");
	if (t.length && !0 !== window.isInitEventsCustomMask) return window.tildaForm_customMasksLoad(),
...
window.tildaForm.validate = function (t) {
	...
	for (var e, r, o = t.querySelectorAll(".js-tilda-rule"), a = [], n = !0, i = 0; i < o.length; i++) {
		...
		if (l && (b || y && h)) f.type.push("req");
			...
			case "phone":
				...
				E += "]+$",
				c = new RegExp(E, "gi"),
				(w.length && !w.match(c) || 1 == (u = w.replace(/[^0-9]+/g, "")).indexOf("000") || 1 == u.indexOf("111") && "9" != u.substring(0, 1) || 1 == u.indexOf("222") && "5" != u.substring(0, 1) || 1 == u.indexOf("333") || 1 == u.indexOf("444") || 1 == u.indexOf("555") && "0" != u.substring(0, 1) || 1 == u.indexOf("666") && "0" != u.substring(0, 1) || 1 == u.indexOf("8888") && "4" != u.substring(0, 1)) && f.type.push("phone");
				break;
			case "number":
				c = /^[0-9]+$/gi,
				0 < w.length && !w.match(c) && f.type.push("number");
				break;
			case "date":
				0 < w.length && !w.match({
			...
			case "time":
				c = /^[0-9]{2}[:\.][0-9]{2}$/gi,
				0 < w.length && !w.match(c) && f.type.push("time");
				break;
			case "name":
	...
	return "y" === g && (e = void 0 !== window.tcart_minorder && 0 < window.tcart_minorder, r = void 0 !== window.tcart_mincntorder && 0 < window.tcart_mincntorder, e && window.tcart.prodamount < window.tcart_minorder && ((f = {
		...
		obj: {},
		type: []
	}).type.push("minquantity"), a.push(f))),
	n && !a.length && (a = [{
		obj: "none",
		type: ["emptyfill"]
	}]),
...
window.tildaForm.showErrorInPopup = function (t, e) {
	...
	c || (document.body.insertAdjacentHTML("beforeend", '<div id="tilda-popup-for-error" class="js-form-popup-errorbox tn-form__errorbox-popup" style="display: none;"> <div class="t-form__errorbox-text t-text t-text_xs"> error </div> <div class="tn-form__errorbox-close js-errorbox-close"> <div class="tn-form__errorbox-close-line tn-form__errorbox-close-line-left"></div> <div class="tn-form__errorbox-close-line tn-form__errorbox-close-line-right"></div> </div> </div>'), t_addEventListener(c = document.getElementById("tilda-popup-for-error"), "click", function (t) {
		if (((t = t || window.event).target || t.srcElement).closest(".js-errorbox-close")) return t.preventDefault ? t.preventDefault() : t.returnValue = !1,
		t_fadeOut(c),
		!1
	}));
	for (var u, m, p = 0; p < e.length; p++) if (e[p] && e[p].obj) {
		...
		f && (n = f.closest(a)),
		n && (s = n.querySelectorAll(".t-input-error"), t_addClass(n, "js-error-control-box"), s.length && (i = !0));
		for (var _ = 0; _ < e[p].type.length; _++) {
			var w = e[p].type[_],
				y = t_forms__getMsg(w),
				l = "";
			(r = t.querySelector(".js-rule-error-" + w)) ? r.textContent && r.innerText || !y || -1 !== d.indexOf(y) ? (l = r.textContent || r.innerText, -1 === d.indexOf(y) && (d = d + '<p class="t-form__errorbox-item">' + l + "</p>")) : d = d + '<p class="t-form__errorbox-item">' + y + "</p>" : y && -1 === d.indexOf(y) && (d = d + '<p class="t-form__errorbox-item">' + y + "</p>"),
			i && (!l && t_forms__getMsg(w + "field") ? l = t_forms__getMsg(w + "field") : y && (l = y), l && n && (s = n.querySelectorAll(".t-input-error"), Array.prototype.forEach.call(s, function (t) {
				t.innerHTML = l,
				t_fadeIn(t)
			})))
		}
	...
	window.isInitEventsZB[o] || (u = t.closest(".r"), m = "focus", document.addEventListener || (m = "focusin"), t_removeEventListener(u, m, h), t_addEventListener(u, m, h, !0), t_removeEventListener(u, "change", h), t_addEventListener(u, "change", h, !0)),
...
window.tildaForm.showErrors = function (t, e) {
	...
	for (var r = (r = t.getAttribute("data-inputbox")) || ".blockinput", o = "", a = !1, n = "", i = "", s = "", l = 0; l < e.length; l++) if (e[l] && e[l].obj) {
		if (0 === l && "none" === e[l].obj) {
			...
			for (var d = 0; d < n.length; d++) n[d].innerHTML = t_forms__getMsg("emptyfill"),
		...
		c && (o = c.closest(r)),
		o && (i = o.querySelectorAll(".t-input-error"), t_addClass(o, "js-error-control-box"), 0 < i.length && (a = !0));
		for (d = 0; d < e[l].type.length; d++) {
			var u = e[l].type[d],
				s = "";
			if (1, (n = t.querySelectorAll(".js-rule-error-" + u)).length) for (var m = 0; m < n.length; m++) n[m].getAttribute("data-rule-filled") || (n[m].textContent && n[m].innerText || !t_forms__getMsg(u) ? s = n[0].textContent || n[0].innerText : n[m].innerHTML = t_forms__getMsg(u)),
			n[m].style.display = "block";
			else if (t_forms__getMsg(u) && (n = t.querySelectorAll(".js-rule-error-all")).length) for (m = 0; m < n.length; m++) n[m].innerHTML = t_forms__getMsg(u),
			n[m].style.display = "block";
...
window.tildaForm.addMebersInfoToForm = function (t) {
	...
	try {
		...
		return console.log("addMebersInfoToForm exception: ", t),
		!1
	}
	return !0
},
...
window.tildaForm.successEnd = function (form, successUrl, successCallback) {
	...
	var successBox = form.querySelector(".js-successbox"),
		...
		dataSuccessMessage;
	successBox && (dataSuccessMessage = successBox.getAttribute("data-success-message"), dataSuccessMessage ? successBox.innerHTML = dataSuccessMessage : successBox.textContent && successBox.innerText || dataSuccessMessage || !successStr || (successBox.innerHTML = successStr), "y" === form.getAttribute("data-success-popup") ? window.tildaForm.showSuccessPopup(successBox.innerHTML) : successBox.style.display = "block"),
...
//						if (t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.tildaSendingStatus = "0", objData && objData.error) {
						if (false || t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.tildaSendingStatus = "0", objData && objData.error) {
							dataSuccessUrl = "",
							dataSuccessCallback = "";
							...
							var formResult = {},
								strValue, strValue;
							objData && objData.results && objData.results[0] ? (strValue = objData.results[0], strValue = strValue.split(":"), formResult.tranId = strValue[0] + ":" + strValue[1], formResult.orderId = strValue[2] || "0", formResult.orderId && "0" !== formResult.orderId && (window.tildaForm.orderIdForStat = formResult.orderId)) : (formResult.tranId = "0", formResult.orderId = "0"),
							...
							if (objData && objData.next && objData.next.type) return window.tildaForm.payment(form, objData.next),
							dataSuccessUrl = "",
							!1;
				...
				if (!xhr || 0 == xhr.status && tsDelta < 100) Array.prototype.forEach.call(allError, function (t) {
					...
					if (xhr && (500 <= xhr.status || 408 == xhr.status || 410 == xhr.status || 429 == xhr.status || "timeout" == xhr.statusText) && -1 !== window.tildaForm.endpoint.indexOf("forms.tilda")) return window.tildaForm.endpoint = "forms2.tildacdn.com",
	...
	xhr.onreadystatechange = function () {
		if (4 === xhr.readyState) if (200 <= xhr.status && xhr.status < 400) {
			...
			if (t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.tildaSendingStatus = "0", l = xhr.responseText) if ("{" == l.substring(0, 1)) {
				var o = JSON.parse(l);
				if ("object" == typeof o) if (o && o.message && "OK" !== o.message) t.innerHTML = o.message;
				else if (o && o.error) {
			...
			var s, a = (s = t_forms__getErrorContainers(form, "")).errorBoxes,
				...
				l = xhr.responseText;
			Array.prototype.forEach.call(n, function (t) {
				l ? t.innerHTML = l + ". Please, try again later. [" + xhr.status + "]" : xhr.statusText ? t.innerHTML = "Error [" + xhr.statusText + "]. Please, try again later. [" + xhr.status + "]" : t.innerHTML = "Unknown error. Please, try again later. [" + xhr.status + "]",
				t.style.display = "block"
			}),
			Array.prototype.forEach.call(a, function (t) {
				t.style.display = "block"
...
try {
	...
	if (-1 !== TILDAPAGE_URL.toLowerCase().indexOf("utm_") && (TILDAPAGE_URL = TILDAPAGE_URL.toLowerCase(), TILDAPAGE_QUERY = TILDAPAGE_URL.split("?"), TILDAPAGE_QUERY = TILDAPAGE_QUERY[1], "string" == typeof TILDAPAGE_QUERY)) {
		...
		0 < TILDAPAGE_UTM.length && (!window.tildastatcookie || "no" != window.tildastatcookie) && (date = new Date, date.setDate(date.getDate() + 30), document.cookie = "TILDAUTM=" + encodeURIComponent(TILDAPAGE_UTM) + "; path=/; expires=" + date.toUTCString())
	}
} catch (error) {}
...
function t_forms__initBtnDblClick(t) {
	if (((t = t || window.event).target || t.srcElement).closest('[type="submit"]')) return t.preventDefault ? t.preventDefault() : t.returnValue = !1,
	!1
}
	...
	if (r) {
		...
		if (o) {
			...
			if (r.tildaSendingStatus && (t = r.tildaSendingStatus), !(t && 1 <= t || t_hasClass(r, "t706__submit_disable"))) {
				if (t_addClass(r, "t-btn_sending"), r.tildaSendingStatus = "1", window.tildaForm.hideErrors(o), e = window.tildaForm.validate(o), window.tildaForm.showErrors(o, e)) return t_removeClass(r, "t-btn_sending"),
				void(r.tildaSendingStatus = "0");
				t = document.getElementById("allrecords").getAttribute("data-tilda-formskey"),
				...
				if (o.querySelector(".g-recaptcha") && grecaptcha) {
					...
					}, n = grecaptcha.render(a + "recaptcha", i), o.tildaCaptchaClientId = n),
...
function t_forms__submitEvent(t) {
	var e, r = t;
	t.target && (r = t.target),
	r && (e = "", (r = r.querySelector('[type="submit"]')) && r.tildaSendingStatus && (e = r.tildaSendingStatus), e && "3" === e ? r.tildaSendingStatus = "" : (r && !t_hasClass(r, "t706__submit_disable") && r.click(), t.preventDefault ? t.preventDefault() : t.returnValue = !1))
}
...
function t_forms__getErrorContainers(t, e) {
	...
	return r.length || (t.insertAdjacentHTML("afterbegin", '<div class="js-errorbox-all"></div>'), r = t.querySelectorAll(".js-errorbox-all")),
...
function checkVerifyTildaCaptcha(t) {
	if (-1 !== (t = t || window.event).origin.indexOf(window.tildaForm.endpoint)) {
		...
		if ("closeiframe" == t.data) return r && t_removeEl(r),
		void(e && t_removeEl(e));
		t = t.data;
...
function t_forms__onSuccess(t) {
	...
	if (l > window.scrollY || n - s < a - 100) o.classList.add(c),
...
function t_forms__scrollBeginForm(t) {
	...
	function t() {
		var e;
		n += i,
		window.scrollTo(0, (e = n, (e /= r / 2) < 1 ? a / 2 * e * e * e + o : a / 2 * ((e -= 2) * e * e + 2) + o)),
		n < r ? setTimeout(t, i) : document.body.removeAttribute("data-scrollable")
	}()
}
...
function t_forms__formData(t) {
	for (var e = "", r = 0; r < t.length; r++)"" !== e && (e += "&"),
...
function t_fadeOut(t) {
	...
	"none" !== t.style.display && (e = 1, r = setInterval(function () {
		t.style.opacity = e,
		(e -= .1) <= .1 && (clearInterval(r), t.style.display = "none", t.style.opacity = null)
	}, 30))
}
function t_fadeIn(t) {
	var e, r;
